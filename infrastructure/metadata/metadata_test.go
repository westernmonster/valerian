...
func TestInt64(t *testing.T) {
	mdcontext := NewContext(context.Background(), MD{AccountID: int64(1)})
	assert.Equal(t, int64(1), Int64(mdcontext, AccountID))
	mdcontext = NewContext(context.Background(), MD{AccountID: int64(2)})
	assert.NotEqual(t, int64(1), Int64(mdcontext, AccountID))
	mdcontext = NewContext(context.Background(), MD{AccountID: 10})
	assert.NotEqual(t, int64(10), Int64(mdcontext, AccountID))
}
