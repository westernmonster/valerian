...
// 2019-05-25 11:41:55.596765 +0800 CST m=+0.153675412
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/models.ArgNewVersion"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.TopicType"
                            }
                        }
                    },
                    "401": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/models.TopicSearchResult"
                            }
                        }
                    },
                    "400": {
    ...
    "definitions": {
        ...
        "models.CreateTopicReq": {
            ...
            "properties": {
                ...
                "catalogs": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TopicLevel1Catalog"
                    }
                },
                "cover": {
                    "description": "封面图\n必须为URL",
                ...
                "members": {
                    ...
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.CreateTopicMemberArg"
                    }
                },
                "mute_notification": {
                    "description": "消息免打扰",
        ...
        "models.Topic": {
            ...
            "properties": {
                ...
                "meta": {
                    "type": "object",
                    "$ref": "#/definitions/models.TopicMeta"
                },
                "mute_notification": {
                    "description": "消息免打扰",
                    "type": "boolean"
        ...
        "models.TopicLevel1Catalog": {
            "type": "object",
            "properties": {
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TopicLevel2Catalog"
                    }
                },
                "id": {
                    "type": "string"
        ...
        "models.TopicLevel2Catalog": {
            "type": "object",
            "properties": {
                "children": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.TopicChildCatalog"
                    }
                },
                "id": {
                    "type": "string"
