...
func (s *helloServer) SayHello(ctx context.Context, in *pb.HelloRequest) (*pb.HelloReply, error) {
	...
	for i := 0; i < cpu+rand.Intn(cpu); i++ {
		crc32.Checksum([]byte(`testasdwfwfsddsfgwddcscschttp://git.flywk.co/platform/valerian/merge_requests/new?merge_request%5Bsource_branch%5D=stress%2Fcodel`), crc32.IEEETable)
	}
