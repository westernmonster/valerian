...
// 2019-10-12 15:36:50.183862 +0800 CST m=+0.025488471
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "object",
                            "$ref": "#/definitions/model.FeedResp"
                        }
                    },
                    "400": {
                        "description": "验证请求失败"
        ...
        "model.FeedItem": {
            ...
            "properties": {
                ...
                "target": {
                    "description": "目标",
                    "type": "object",
                    "$ref": "#/definitions/model.FeedTarget"
                },
                "target_type": {
        ...
        "model.FeedTarget": {
            ...
            "properties": {
                "article": {
                    "description": "文章",
                    "type": "object",
                    "$ref": "#/definitions/model.TargetArticle"
                },
                "comment": {
                    "description": "评论",
                    "type": "object",
                    "$ref": "#/definitions/model.TargetComment"
                },
                "discussion": {
                    "description": "讨论",
                    "type": "object",
                    "$ref": "#/definitions/model.TargetDiscuss"
                },
                "id": {
                    "description": "ID",
                    "type": "string"
                ...
                "member": {
                    "description": "用户",
                    "type": "object",
                    "$ref": "#/definitions/model.MemberInfo"
                },
                "revise": {
                    "description": "补充",
                    "type": "object",
                    "$ref": "#/definitions/model.TargetRevise"
                },
                "topic": {
                    "description": "话题",
                    "type": "object",
                    "$ref": "#/definitions/model.TargetTopic"
                },
                "type": {
                    "description": "类型: article,comment,account,topic",
                    "type": "string"
                }
            }
        },
        "model.MemberInfo": {
            ...
            "properties": {
                ...
                "stat": {
                    "description": "状态",
                    "type": "object",
                    "$ref": "#/definitions/model.MemberInfoStat"
                },
                "user_name": {
                    "description": "用户名",
                    "type": "string",
