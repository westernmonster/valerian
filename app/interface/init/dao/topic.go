...
func (p *Dao) GetRecommendAuthTopicsIDs(c context.Context, arg *api.IDsReq) (resp *api.IDsResp, err error) {
...
func (p *Dao) GetRecommendMemberIDs(c context.Context, arg *api.IDsReq) (resp *api.IDsResp, err error) {
