...
func (p *Dao) GetUserTopicsPaged(c context.Context, aid int64, limit, offset int32) (resp *topic.UserTopicsResp, err error) {
...
func (p *Dao) GetFollowedTopicIDsPaged(c context.Context, aid int64, limit, offset int32) (resp *topic.IDsResp, err error) {
...
func (p *Dao) GetManageTopicIDsPaged(c context.Context, aid int64, limit, offset int32) (resp *topic.IDsResp, err error) {
