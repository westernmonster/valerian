...
// @Param req body  app.interface.passport-login.model.ArgEmailLogin true "用户登录"
// @Success 200 {object}  app.interface.passport-login.model.LoginResp "成功"
// @Failure 626 "用户不存在"
...
// @Param Locale header string true "语言" Enums(zh-CN, en-US)
// @Param req body  app.interface.passport-login.model.ArgMobileLogin true "手机登录"
// @Success 200 {object}  app.interface.passport-login.model.LoginResp "成功"
// @Failure 626 "用户不存在"
// @Failure 116 "Client 不存在"
// @Failure 629 "密码错误"
...
// @Param Source header int true "Source 来源，1:Web, 2:iOS; 3:Android" Enums(1, 2, 3)
// @Param Locale header string true "语言" Enums(zh-CN, en-US)
// @Param req body  app.interface.passport-login.model.ArgDigitLogin true "手机登录"
// @Success 200 {object}  app.interface.passport-login.model.LoginResp "成功"
// @Failure 626 "用户不存在"
// @Failure 116 "Client 不存在"
// @Failure 2 "验证码已失效"
