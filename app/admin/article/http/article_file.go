...
// @Param req body  app.admin.article.model.ArgSaveArticleFiles true "请求"
// @Success 200 "成功"
// @Failure 400 "验证请求失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/article/files [post]
...
// @Success 200 {array}  app.admin.article.model.ArticleFileResp "文件列表"
// @Failure 400 "请求验证失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/article/list/files [get]
