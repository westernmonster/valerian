...
// @Success 200 {array}  app.admin.article.model.ArticleHistoryListResp "历史记录"
// @Failure 400 "请求验证失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/article/list/histories [get]
...
// @Success 200 {object}  app.admin.article.model.ArticleHistoryResp "历史记录"
// @Failure 400 "请求验证失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/article/history/get [get]
