...
// @Success 200 {object}  app.admin.search.model.TopicSearchResult "话题"
// @Failure 400 "验证请求失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/search/topics [get]
...
// @Param debug query bool false "debug"
// @Param source query bool false "所需要展示的字段，逗号分隔"
// @Success 200 {object}  app.admin.search.model.AccountSearchResult "话题"
// @Failure 400 "验证请求失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/search/accounts [get]
...
// @Param debug query bool false "debug"
// @Param source query bool false "所需要展示的字段，逗号分隔"
// @Success 200 {object}  app.admin.search.model.ArticleSearchResult "话题"
// @Failure 400 "验证请求失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
// @Router /admin/search/articles [get]
...
// @Param debug query bool false "debug"
// @Param source query bool false "所需要展示的字段，逗号分隔"
// @Success 200 {object}  app.admin.search.model.DiscussionSearchResult "话题"
// @Failure 400 "验证请求失败"
// @Failure 401 "登录验证失败"
// @Failure 500 "服务器端错误"
