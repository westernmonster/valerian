...
import (
	...
	"valerian/app/service/like/conf"
	server "valerian/app/service/like/server/grpc"
	"valerian/app/service/like/server/http"
...
func main() {
	...
	for {
		s := <-c
		log.Infof("like-service get a signal %s", s.String())
		switch s {
