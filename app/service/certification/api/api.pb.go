...
func (c *certificationClient) GetWorkCertsPaged(ctx context.Context, in *WorkCertPagedReq, opts ...grpc.CallOption) (*WorkCertPagedResp, error) {
	out := new(WorkCertPagedResp)
	err := c.cc.Invoke(ctx, "/service.certification.Certification/GetWorkCertsPaged", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Certification_GetWorkCertsPaged_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WorkCertPagedReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CertificationServer).GetWorkCertsPaged(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.certification.Certification/GetWorkCertsPaged",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CertificationServer).GetWorkCertsPaged(ctx, req.(*WorkCertPagedReq))
	}
	return interceptor(ctx, in, info, handler)
}
