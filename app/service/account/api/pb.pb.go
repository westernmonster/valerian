...
type AccountStatInfo struct {
	...
	TopicCount           int32    `protobuf:"varint,2,opt,name=TopicCount,proto3" json:"topic_count"`
	ArticleCount         int32    `protobuf:"varint,3,opt,name=ArticleCount,proto3" json:"article_count"`
	DiscussionCount      int32    `protobuf:"varint,4,opt,name=DiscussionCount,proto3" json:"discussion_count"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *AccountStatInfo) GetAccountID() int64 {
	if m != nil {
		return m.AccountID
	}
	return 0
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
