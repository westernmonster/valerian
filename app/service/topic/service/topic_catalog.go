...
func (p *Service) createCatalog(c context.Context, node sqalx.Node, topicID int64, name string, seq int32, rtype string, refID int64, parentID int64) (id int64, err error) {
	// // 当前为分类，则不允许处于第三级
