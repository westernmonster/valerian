...
import (
	...
	server "valerian/app/service/recent/server/grpc"
	"valerian/app/service/recent/server/http"
...
func main() {
	...
	for {
		s := <-c
		log.Infof("recent-service get a signal %s", s.String())
		switch s {
