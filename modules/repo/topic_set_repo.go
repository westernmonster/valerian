...
func (p *TopicSetRepository) QueryListPaged(ctx context.Context, node sqalx.Node, page int, pageSize int, cond map[string]string) (total int, items []*TopicSet, err error) {
...
func (p *TopicSetRepository) GetAll(ctx context.Context, node sqalx.Node) (items []*TopicSet, err error) {
	items = make([]*TopicSet, 0)
...
func (p *TopicSetRepository) GetAllByCondition(ctx context.Context, node sqalx.Node, cond map[string]string) (items []*TopicSet, err error) {
	items = make([]*TopicSet, 0)
	condition := make(map[string]interface{})
	clause := ""
...
func (p *TopicSetRepository) GetByID(ctx context.Context, node sqalx.Node, id int64) (item *TopicSet, exist bool, err error) {
	item = new(TopicSet)
...
func (p *TopicSetRepository) GetByCondition(ctx context.Context, node sqalx.Node, cond map[string]string) (item *TopicSet, exist bool, err error) {
	item = new(TopicSet)
	condition := make(map[string]interface{})
	clause := ""
...
func (p *TopicSetRepository) Update(ctx context.Context, node sqalx.Node, item *TopicSet) (err error) {
...
func (p *TopicSetRepository) Delete(ctx context.Context, node sqalx.Node, id int64) (err error) {
...
func (p *TopicSetRepository) BatchDelete(ctx context.Context, node sqalx.Node, ids []int64) (err error) {
